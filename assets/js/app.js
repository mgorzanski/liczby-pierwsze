...
var tableOfContents = document.querySelector('.table-of-contents__menu');

var waypoint1 = new Waypoint({
    element: document.getElementById("wprowadzenie"),
    handler: function handler() {
        var item = (0, _jquery2.default)("a[href='#wprowadzenie']");
...
var waypoint2 = new Waypoint({
    ...
    handler: function handler() {
        var item = (0, _jquery2.default)("a[href='#definicja-liczb-pierwszych']");
        if (!item.hasClass('table-of-contents__active')) {
            item.classList.toggle('table-of-contents__active');
        }
    }
